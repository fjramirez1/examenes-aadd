...
import aadd.podcast.utils.MongoDBConnectionManager;
import aadd.podcast.utils.PropertiesReader;

public class RepositorioPodcastMongoDB extends RepositorioMongoDB<Podcast> {

	private MongoCollection<Podcast> collection;
	protected MongoDatabase database;

	public RepositorioPodcastMongoDB() throws IOException {
	...
	@Override
	public MongoCollection<Podcast> getCollection() {
		return collection;
	}
