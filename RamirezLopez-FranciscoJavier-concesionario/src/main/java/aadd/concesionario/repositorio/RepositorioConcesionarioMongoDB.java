...
import aadd.concesionario.utils.MongoDBConnectionManager;
import aadd.concesionario.utils.PropertiesReader;

public class RepositorioConcesionarioMongoDB extends RepositorioMongoDB<Coche> {

	private MongoCollection<Coche> collection;
	protected MongoDatabase database;

	public RepositorioConcesionarioMongoDB() throws IOException {
		...
		collection = database.getCollection("coches", Coche.class).withCodecRegistry(defacultCodecRegistry);

	}

	@Override
	public MongoCollection<Coche> getCollection() {
		return collection;
	}
